...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        mainMenu = new Scene(
                FXMLLoader.load(getClass().getResource("/com/maemresen/guessnumber/mainMenu.fxml"))
        );

        inGameMenu = new Scene(
                FXMLLoader.load(getClass().getResource("/com/maemresen/guessnumber/sample.fxml")),1100,300
        );
